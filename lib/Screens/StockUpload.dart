                                      ...
                                      btnOkOnPress: () async {
                                        Future SaveFeedStockdata() async {
                                          ...
                                          final docUser = FirebaseFirestore
                                              .instance
                                              .collection("FeedStockInfo")
                                              .doc(StockID);

                                          final SetData = {
                                            "StockID ": StockID,
                                            "FeedName":
                                                FeedNameController.text.trim(),
                                            "FeedBagNumber":
                                                BagNumber.text.trim(),
                                            "SaveFeedBagNumber":
                                                BagNumber.text.trim(),
                                            ...
                                            "PerBagSalePrice":
                                                PerBagSalePrice.text.trim(),
                                            "PerKgSalePrice":
                                                PerKgSalePrice.text.trim(),
                                            "PerBagBuyingPrice":
                                                PerBagBuyingPrice.text.trim(),
                                            "PerKgBuyingPrice":double.parse(PerBagBuyingPrice.text.trim().toString())/(selectedValue?.split(" ")[0]=="২৫"?25:50),
                                            "KhuchraAmountKg": 0,
                                            "Date": DateTime.now()
                                                .toIso8601String(),
                                            "month":
